build:
	docker build --no-cache --pull . --build-arg julia_version=1.3.0 -t johnnychen94/juliabook:stable
	...
	docker build --no-cache --pull . --build-arg julia_version=1.3.0 -t johnnychen94/juliabook:1.3
